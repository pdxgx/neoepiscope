...
def kmer(mutation_posits, normal_aa, mutated_aa = ""):
            ...
            if strand == "-":
                ...
                if len(cds_list) != 0:
                    ...
                    try:
                        ...
                        kmer(mutation_posits, seq_to_peptide(orig_seq, reverse_strand=True), seq_to_peptide(mutation_seq, reverse_strand=True))
